...
const de = {
  ...
  legendMeasured: "gemessen",
  legendEstimated: (sport: Sport): string =>
    sport === "ride" ? "geschätzt (Effort/FTP)" : "geschätzt (Riegel)",
  legendFtp: "FTP-Anker",
  legendTargetFeasible: (label: string) => `${label}-Ziel in Reichweite`,
  legendTargetFar: (label: string) => `${label}-Ziel außer Reichweite`,
  supportsTitle: "Stützpunkte der Kurve",
  thDuration: "Dauer",
  thBest: "Bestwert",
  thSource: "Quelle",
  thActivity: "Einheit",
  kindStream: "Watt-Stream",
  kindEffort: "Effort",
  kindFtp: "FTP (Profil)",
  ftpFromProfile: "Strava-Profil",
  openActivity: (name: string) => `Aktivität ${name} auf Strava öffnen`,
...
const en: Messages = {
  ...
  legendEstimated: (sport) => (sport === "ride" ? "estimated (effort/FTP)" : "estimated (Riegel)"),
  legendFtp: "FTP anchor",
  legendTargetFeasible: (label) => `${label} target within reach`,
  legendTargetFar: (label) => `${label} target out of reach`,
  supportsTitle: "Curve support efforts",
  thDuration: "Duration",
  thBest: "Best value",
  thSource: "Source",
  thActivity: "Activity",
  ...
  kindEffort: "Effort",
  kindFtp: "FTP (profile)",
  ftpFromProfile: "Strava profile",
  openActivity: (name) => `Open activity ${name} on Strava`,
